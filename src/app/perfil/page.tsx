...
export default function PerfilPage() {
  ...
  // Temporariamente desabilitado pois VisualPreferencesProvider está desabilitado
  ...
  return (
    <section className="animate-in fade-in slide-in-from-left-4 duration-1000">
      ...
      {items.length === 0 ? (
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-4 tv-grid-layout gap-4 sm:gap-6">
          {items.map(item => {
