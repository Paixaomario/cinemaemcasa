          ...
          <div className="bg-neutral-900 rounded-2xl p-6 sm:p-8 max-w-md w-full border border-white/10 shadow-2xl">
            <div className="flex items-start gap-4 mb-6">
              <div className="w-24 h-36 flex-shrink-0 rounded-lg overflow-hidden bg-neutral-800">
                {series?.poster || series?.backdrop_path ? (
                  <Image
                    src={(series.poster || series.backdrop_path).startsWith('http') ? (series.poster || series.backdrop_path) : `https://image.tmdb.org/t/p/w500${series.poster || series.backdrop_path}`}
                    alt={series.titulo}
                    width={96}
                    height={144}
