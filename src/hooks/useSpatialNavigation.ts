...
export function useSpatialNavigation() {
  useEffect(() => {
    ...
    // A função findNextFocusable foi removida.
    // A navegação por setas agora é 100% controlada pelo motor nativo da TV,
    // o que é muito mais performático e resolve os problemas de travamento e foco.
    // O hook permanece para capturar outros eventos como 'Voltar' e botões coloridos.
    ...
    const handleKeyDown = (e: KeyboardEvent) => {
      ...
      if (isArrowKey) {
        ...
        // e.preventDefault() foi removido para permitir que o navegador/TV
        // execute sua ação padrão de navegação espacial.
      }
